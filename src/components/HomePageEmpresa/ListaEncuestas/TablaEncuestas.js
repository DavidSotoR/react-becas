...
export default function TablaEncuestas({
  ...
  const columns = [
    ...
    {
      name: <div style={{ whiteSpace: "pre-wrap" }}>No. Familia Colegio</div>,
      cell: (row) =>
    ...
    ...listaParametros.map((parametro) => ({
      ...
      selector: (row) =>
        getPuntosParametros(row.parametros, parametro.id) || "-",
      sortable: true,
    })),
    {
      name: "Total",
    ...
    {
      name: <div style={{ whiteSpace: "pre-wrap" }}>Porcentaje Sugerido</div>,
  ...
  return (
    <>
      ...
      <ModalPorcentajeOtorgado
        show={show}
        handleClose={handleClose}
        idEstudio={idEstudio}
        idEstudioHijo={idEstudioHijo}
      />
      <ModalNumeroFamiliaColegio
        show={showClaveFamilia}
        handleClose={handleCloseClaveFamilia}
        idEstudio={idEstudio}
        claveFamiliaColegio={claveFamiliaColegio}
      />
    </>
  );
}
