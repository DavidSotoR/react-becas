...
function FamiliaAlta() {
    ...
    const [dataFormFamilia, setDataFormFamilia] = useState({})
    ...
    return (
        <div className="container mt-3">
            ...
            <div className="row mt-3 mb-3">
                ...
                <div className="col">
                    <input onChange={ (e)=>{handleChangeInput(e)} } name="familia_nombre" type="text" id="inputFamiliaName" className="form-control form-control-sm" />
                </div>
            </div>
            ...
            <div className="container">
                <div className="row p-3 card mb-3" style={{ flexDirection: "row" }}>
                    ...
                    <div className="col-4">
                        ...
                        <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_domicilio" type="text" id="inputDomicilio" className="form-control" />
                    </div>
                    <div className="col-4">
                        <label for="inputColonia" class="form-label">Colonia:</label>
                        <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_colonia" type="text" id="inputColonia" className="form-control" />
                    </div>
                    <div className="col-4">
                        <label for="inputMunicipio" class="form-label">Municipio:</label>
                        <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_municipio" type="text" id="inputMunicipio" className="form-control" />
                    </div>
                    <div className="col-4">
                        <label for="inputCP" class="form-label">Codigo Postal:</label>
                        <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_cp" type="text" id="inputCP" className="form-control" />
                    </div>
                    <div className="row">
                        <div className="col-5">
                            <label for="inputTelPadre" class="form-label">Telefono Padre:</label>
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_padre_tel" type="text" id="inputTelPadre" className="form-control" />
                        </div>
                        <div className="col-5">
                            <label for="inputTelMadre" class="form-label">Telefono Madre:</label>
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="alumnos_madre_tel" type="text" id="inputTelMadre" className="form-control" />
                        </div>
                    </div>
                </div>
                <div className="row p-3 card mb-3">
                    ...
                    <div className="row">
                        <div className="col-6">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="padre_nombre" 
                            type="text" id="inputNombrePadre" className="form-control" />
                        </div>
                        <div className="col-2">
                            <label for="inputEdadPadre" class="form-label">Edad:</label>
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="padre_edad"
                        ...
                        <div className="col-2">
                            ...
                            onChange={ (e)=>{handleChangeInput(e)} } name="padre_vive"
                        ...
                        <div className="col-12">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="padre_direccion"
                        ...
                        <div className="col-12">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="padre_ocupacion"
                ...
                <div className="row p-3 card mb-3">
                    ...
                    <div className="row">
                        <div className="col-6">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="madre_nombre"
                            type="text" id="inputNombrePadre" className="form-control" />
                        </div>
                        <div className="col-2">
                            <label for="inputEdadMadre" class="form-label">Edad:</label>
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="madre_edad"
                            type="text" id="inputEdadMadre" className="form-control" />
                        </div>
                        <div className="col-2">
                            <label for="inputMadreVive" class="form-label">Vive:</label>
                            <select id="inputMadreVive" class="form-select form-select-sm" 
                            onChange={ (e)=>{handleChangeInput(e)} } name="madre_vive"
                            aria-label="Small select example">
                                <option value="si">SI</option>
                                <option value="no">NO</option>
                            </select>
                        ...
                        <div className="col-12">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="madre_direccion"
                        ...
                        <div className="col-12">
                            ...
                            <input onChange={ (e)=>{handleChangeInput(e)} } name="madre_ocupacion"
