...
function TablaClientesProyecto({ ID , idTipoCliente}) {
    ...
    const getClientesProyectoID = () =>{
        axios.get(`${APIURL}/proyectos/${ID}/clientes-encuestas`,config).then((resp)=>{
    ...
    const renderFilasTablaClientes = () => {
        return allClientesFiltrados.map((a, index) => (
            <tr key={'tr-cliente-'+index}>
                ...
                <td>
                    <p><ResaltarTexto texto={a.cliente.nombre} reslatar={search}/></p>
                </td>
                <td>
                    <p>Opciones</p>
                </td>
            ...
            <div className='tab-content'>
                {allClientesFiltrados.map((a,i) =>(
                    <div key={'pg-' + a.cliente.id} 
                            ...
                            <div className="">
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li><button className="dropdown-item" type="button">Nueva orden de servicio</button></li>
                                    </ul>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div>
                            {/*JSON.stringify(a)*/}
                            <TablaOrdenesDeTrabajo ID={ID} idCliente={a.id_cliente} idTipoCliente={a.id_tipo_cliente}></TablaOrdenesDeTrabajo>
